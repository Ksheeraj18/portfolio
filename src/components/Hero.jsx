...
export default function Hero({ performanceMode = 'high', isScrolling = false }) {
    ...
    return (
        <section id="home" className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden pt-32 pb-20">
            ...
            <ParticleBackground paused={showResume || performanceMode === 'low'} performanceMode={performanceMode} />
                        ...
                        >
                            {nameLetters.split('').map((letter, i) => (
                                <motion.span
                                    ...
                                    className="inline-block hover:text-[#8b5cf6] transition-colors duration-200"
